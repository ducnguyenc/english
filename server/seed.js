// Bản JS song song với src/data/seed.ts, dùng để seed DB lần đầu khi bảng content_items rỗng.
// Nếu bạn sửa dữ liệu mẫu, nhớ sửa cả 2 file (hoặc xoá seed này sau khi đã tự nhập liệu qua /admin).
